...
import {
  ...
  AlertTriangle, Mail, Shield, Menu, X, ChevronRight, ShieldCheck, Tag, BarChart2, Key, Smile, MessageSquareWarning,
} from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { label: 'Flagged Messages',   href: '/dashboard/admin/flagged-messages',        icon: MessageSquareWarning },
