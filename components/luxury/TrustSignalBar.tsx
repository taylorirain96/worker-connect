...
export default function TrustSignalBar() {
  return (
    <div className="flex flex-wrap items-center gap-4 sm:gap-6 px-4 sm:px-8 py-3.5 bg-slate-900/80 border-b border-slate-800/80 backdrop-blur-sm">
      ...
      <Link
        href="/jobs/create"
        className="ml-auto inline-flex items-center gap-2 bg-gradient-to-r from-indigo-500 to-indigo-600 text-white font-bold text-sm px-5 py-2 rounded-lg shadow-indigo-glow hover:shadow-indigo-glow-lg hover:scale-105 transition-all duration-300 animate-pulse-indigo-slow flex-shrink-0"
      >
        Post a Job
