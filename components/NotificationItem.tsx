...
export default function NotificationItem({
  ...
  return (
    <div className={`flex gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/40 transition-colors group ${bgColor}`}>
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className={`text-sm text-gray-800 dark:text-gray-200 leading-snug ${!n.read ? 'font-medium' : ''}`}>
          {n.message}
        </p>
